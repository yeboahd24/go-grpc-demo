...
type ProductServiceClient interface {
	...
	CheckProductAvailability(ctx context.Context, in *ProductRequest, opts ...grpc.CallOption) (*ProductResponse, error)
}
...
func (c *productServiceClient) CheckProductAvailability(ctx context.Context, in *ProductRequest, opts ...grpc.CallOption) (*ProductResponse, error) {
...
type ProductServiceServer interface {
	// Check if a product is available
	CheckProductAvailability(context.Context, *ProductRequest) (*ProductResponse, error)
...
func (UnimplementedProductServiceServer) CheckProductAvailability(context.Context, *ProductRequest) (*ProductResponse, error) {
...
func _ProductService_CheckProductAvailability_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).CheckProductAvailability(ctx, req.(*ProductRequest))
	}
